...
<section>
    ...
    <form method="post" onsubmit="return confirmInsert();">
        ...
        <label for="aid">attendee_id:</label>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $connection->prepare("INSERT INTO attendees(attendee_id,id, event_id) VALUES (?, ?, ?)");
    $stmt->bind_param("sss", $aid, $uid, $eid );
      ...
      include('database_connection.php');
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                $aid = $row['attendee_id']; // Fetch the attendee_id
                echo "<tr>
                    ...
                    <td><a style='padding:4px' href='delete_attendees.php?attendee_id=$aid'>Delete</a></td> 
                    <td><a style='padding:4px' href='update_attendees.php?attendee_id=$aid'>Update</a></td> 
                </tr>";
            }
        } else {
