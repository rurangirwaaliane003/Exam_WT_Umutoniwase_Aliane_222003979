...
<body style="background-image: url('./images/pne.jpg');background-repeat: no-repeat;background-size: cover;">

<div class="overlay">
  <div class="container">
    <h1 style="color: pink;">WELCOME TO PROFESSIONAL_NETWORKING_EVENTS</h1>
