...
<section>
    ...
    <form method="post" onsubmit="return confirmInsert();">
        ...
        <input type="text" id="oid" name="oid"><br><br>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $connection->prepare("INSERT INTO events(event_id, organizer_id, event_name) VALUES (?, ?, ?)");
    $stmt->bind_param("iss", $eid, $oid, $ename);
